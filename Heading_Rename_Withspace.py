...
file_name = '/Users/KenBradshaw/git/pipeline/SFBR_barcode_filtered/barcode_filtered_SFBR-Rain-Event-500_S1_L001_R1_001.fasta/result_dir/NoTag/NoTag_trimmed.fasta' # Name of input file
...
for line in content:
        ...
        if i % 2 == 0:
                content[i] = '>500' # Replace headers (always even-numbered index)
        else:
                content[i] = content[i] + '\n'
