# Join paired end reads using join_paired_ends.py from QIIME 
...
##Create and Run join_paired_ends.py script for each sample
...
##File commands to to convert fastq to fasta
```{r,echo=TRUE,eval=TRUE,include=TRUE,messages=TRUE,error=TRUE}
