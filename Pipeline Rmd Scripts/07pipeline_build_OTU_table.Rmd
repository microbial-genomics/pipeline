...
otu.file.wpath <- paste(otu.dir,"/","otu_table.biom",sep="")
```
###OTU .BIOM file
```{r,echo=TRUE,eval=TRUE,include=TRUE,messages=TRUE,error=TRUE}
otu.file.wpath
...
```
###OTU .BIOM file with Singletons Removed
```{r,echo=TRUE,eval=TRUE,include=TRUE,messages=TRUE,error=TRUE}
